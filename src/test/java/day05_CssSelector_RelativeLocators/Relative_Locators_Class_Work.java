...
public class Relative_Locators_Class_Work {
    public static void main(String[] args) {
        ...
        WebElement BerlinWbElement = driver.findElement(with(By.tagName("img")).below(NYCWebelement).toLeftOf(BayAreaWebelement));
        BerlinWbElement.click();

        //Relative locator'larin dogru calistigini test edin
        String actualIdDegeri = BerlinWbElement.getAttribute("id");
